...
public class SanPedro extends AppCompatActivity implements AdapterView.OnItemSelectedListener {

    EditText Distance, Fare, FareO;

    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.sanpedro);
        ...
        // Spinner element
        Spinner spinner = (Spinner) findViewById(R.id.spinnerSanPedro);
    ...
    public void MapSanPedro(View v){
              Intent i=null, chooser=null;
              if(v.getId()== R.id.SanPedroMap){
                i = new Intent(Intent.ACTION_VIEW);
                  i.setData(Uri.parse("geo:14.361605, 121.055353"));
