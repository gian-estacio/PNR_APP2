...
public class Mamatid extends AppCompatActivity implements AdapterView.OnItemSelectedListener {

    EditText Distance, Fare, FareO;

    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.mamatid);
        ...
        // Spinner element
        Spinner spinner = (Spinner) findViewById(R.id.spinnerMamatid);
    ...
    public void MapMamatid(View v){
              Intent i=null, chooser=null;
              if(v.getId()== R.id.MamatidMap){
                 i = new Intent(Intent.ACTION_VIEW);
                 i.setData(Uri.parse("geo:14.232307, 121.145639"));
