...
public class Buendia extends AppCompatActivity implements AdapterView.OnItemSelectedListener {

    EditText Distance, Fare, FareO;

    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.buendia);
        ...
        // Spinner element
        Spinner spinner = (Spinner) findViewById(R.id.spinnerBuendia);
    ...
    public void MapBuendia(View v){
        Intent i=null, chooser=null;
        if(v.getId()== R.id.BuendiaMap){
