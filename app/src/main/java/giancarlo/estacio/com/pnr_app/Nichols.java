...
public class Nichols extends AppCompatActivity implements AdapterView.OnItemSelectedListener {

    EditText Distance, Fare, FareO;

    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.nichols);
        ...
        // Spinner element
        Spinner spinner = (Spinner) findViewById(R.id.spinnerNichols);
    ...
    public void MapNichols(View v){
             Intent i=null, chooser=null;
             if(v.getId()== R.id.NicholsMap){
                 i = new Intent(Intent.ACTION_VIEW);
               i.setData(Uri.parse("geo:14.523478, 121.026283"));
