...
public class FoodT extends AppCompatActivity implements AdapterView.OnItemSelectedListener {

    EditText Distance, Fare, FareO;

    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.foodterm);
        ...
        // Spinner element
        Spinner spinner = (Spinner) findViewById(R.id.spinnerFoodT);
    ...
    public void MapFood(View v){
              Intent i=null, chooser=null;
             if(v.getId()== R.id.FoodMap){
                 i = new Intent(Intent.ACTION_VIEW);
                 i.setData(Uri.parse("geo:14.503241, 121.043757"));
