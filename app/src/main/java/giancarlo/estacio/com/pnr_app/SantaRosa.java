...
public class SantaRosa extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Spinner element
        Spinner spinner = (Spinner) findViewById(R.id.spinnerSantaRosa);
    ...
    public void MapSantaRosa(View v){
               Intent i=null, chooser=null;
              if(v.getId()== R.id.SantaRosaMap){
                  i = new Intent(Intent.ACTION_VIEW);
                  i.setData(Uri.parse("geo:14.306131, 121.109779"));
