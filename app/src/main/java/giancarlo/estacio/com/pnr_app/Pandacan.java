...
public class Pandacan extends AppCompatActivity implements AdapterView.OnItemSelectedListener {

    EditText Distance, Fare, FareO;

    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.pandacan);
        ...
        // Spinner element
        Spinner spinner = (Spinner) findViewById(R.id.spinnerPandacan);
    ...
    public void MapPandacan(View v){
             Intent i=null, chooser=null;
            if(v.getId()== R.id.PandacanMap){
                i = new Intent(Intent.ACTION_VIEW);
                 i.setData(Uri.parse("geo:14.590376, 121.008823"));
