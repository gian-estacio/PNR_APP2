...
public class Laon extends AppCompatActivity implements AdapterView.OnItemSelectedListener {

    EditText Distance, Fare, FareO;

    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.laon);
        ...
        // Spinner element
        Spinner spinner = (Spinner) findViewById(R.id.spinnerLaon);
    ...
    public void MapLaon(View v){
              Intent i=null, chooser=null;
              if(v.getId()== R.id.LaonMap){
                  i = new Intent(Intent.ACTION_VIEW);
                  i.setData(Uri.parse("geo:14.616844, 120.992610"));
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        ...
        switch (item){
            case "Tutuban":
                ...
                String FareAC_dMM = "15.00 PHP";
                Fare.setText(FareAC_dMM);
                String FareOrd_dMM = "12.00 PHP";
            ...
            case "Cabuyao":
                ...
                break;
            case "Mamatid":
                String dMMa = "52.95 KM";
                Distance.setText(dMMa);
                String FareAC_dMMa = "55.00 PHP";
                Fare.setText(FareAC_dMMa);
                String FareOrd_dMMa = "44.00 PHP";
                FareO.setText(FareOrd_dMMa);
                break;
            case "Calamba":
