...
public class Golden extends AppCompatActivity implements AdapterView.OnItemSelectedListener {

    EditText Distance, Fare, FareO;

    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.golden);
        ...
        // Spinner element
        Spinner spinner = (Spinner) findViewById(R.id.spinnerGolden);
    ...
    public void MapGolden(View v){
              Intent i=null, chooser=null;
             if(v.getId()== R.id.GoldenMap){
                  i = new Intent(Intent.ACTION_VIEW);
                 i.setData(Uri.parse("geo:14.336778, 121.075076"));
