...
public class Espana extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Spinner element
        Spinner spinner = (Spinner) findViewById(R.id.spinnerEspana);
    ...
    public void MapEspana(View v){
             Intent i=null, chooser=null;
             if(v.getId()== R.id.EspanaMap){
                i = new Intent(Intent.ACTION_VIEW);
                i.setData(Uri.parse("geo:14.612332, 120.996913"));
