...
public class Muntinlupa extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Spinner element
        Spinner spinner = (Spinner) findViewById(R.id.spinnerMuntinlupa);
    ...
    public void MapMuntinlupa(View v){
           Intent i=null, chooser=null;
           if(v.getId()== R.id.MuntinlupaMap){
               i = new Intent(Intent.ACTION_VIEW);
               i.setData(Uri.parse("geo:14.389507, 121.047549"));
