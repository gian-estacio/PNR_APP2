...
public class PasayRoad extends AppCompatActivity implements AdapterView.OnItemSelectedListener {

    EditText Distance, Fare, FareO;

    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.pasayroad);
        ...
        // Spinner element
        Spinner spinner = (Spinner) findViewById(R.id.spinnerPasayRoad);
    ...
    public void MapPasay(View v){
            Intent i=null, chooser=null;
          if(v.getId()== R.id.PasayMap){
              i = new Intent(Intent.ACTION_VIEW);
               i.setData(Uri.parse("geo:14.549716, 121.012184"));
