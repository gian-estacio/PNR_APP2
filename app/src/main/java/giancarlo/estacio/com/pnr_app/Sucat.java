...
public class Sucat extends AppCompatActivity implements AdapterView.OnItemSelectedListener {

    EditText Distance, Fare, FareO;

    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.sucat);
        ...
        // Spinner element
        Spinner spinner = (Spinner) findViewById(R.id.spinnerSucat);
    ...
    public void MapSucat(View v){
              Intent i=null, chooser=null;
              if(v.getId()== R.id.SucatMap){
                 i = new Intent(Intent.ACTION_VIEW);
                 i.setData(Uri.parse("geo:14.452357, 121.050876"));
