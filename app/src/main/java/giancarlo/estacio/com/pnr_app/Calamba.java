...
public class Calamba extends AppCompatActivity implements AdapterView.OnItemSelectedListener {

    EditText Distance, Fare, FareO;

    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.calamba);
        ...
        // Spinner element
        Spinner spinner = (Spinner) findViewById(R.id.spinnerCalamba);
