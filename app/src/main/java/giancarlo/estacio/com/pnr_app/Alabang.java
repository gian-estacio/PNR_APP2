...
import giancarlo.estacio.com.pnr_app.Fares;
import giancarlo.estacio.com.pnr_app.R;

public class Alabang extends AppCompatActivity implements AdapterView.OnItemSelectedListener {

    EditText Distance, Fare, FareO;

    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.alabang);

        Distance = findViewById(R.id.eDistance);
        Fare = findViewById(R.id.eFare);
        FareO = findViewById(R.id.eFareO);
        // Spinner element
        Spinner spinner = (Spinner) findViewById(R.id.spinnerAlabang);
    ...
    public void Fares(View v) {
     ...
     public void MapAlabang(View v){
           Intent i=null, chooser=null;
         if(v.getId()== R.id.AlabangMap){
             i = new Intent(Intent.ACTION_VIEW);
             i.setData(Uri.parse("geo:14.417470,121.047789"));
