...
public class Cabuyao extends AppCompatActivity implements AdapterView.OnItemSelectedListener {

    EditText Distance, Fare, FareO;

    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.cabuyao);
        ...
        // Spinner element
        Spinner spinner = (Spinner) findViewById(R.id.spinnerCabuyao);
    ...
    public void MapCabuyao(View v){
        Intent i=null, chooser=null;
        if(v.getId()== R.id.CabuyaoMap){
            i = new Intent(Intent.ACTION_VIEW);
            i.setData(Uri.parse("geo:14.279992, 121.126222"));
