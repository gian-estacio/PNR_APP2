...
public class Binan extends AppCompatActivity implements AdapterView.OnItemSelectedListener {

    EditText Distance, Fare, FareO;

    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.binan);
        ...
        // Spinner element
        Spinner spinner = (Spinner) findViewById(R.id.spinnerBinan);
