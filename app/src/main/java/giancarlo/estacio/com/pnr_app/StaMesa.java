...
public class StaMesa extends AppCompatActivity implements AdapterView.OnItemSelectedListener {

    EditText Distance, Fare, FareO;

    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.stamesa);
        ...
        // Spinner element
        Spinner spinner = (Spinner) findViewById(R.id.spinnerStaMesa);
    ...
    public void MapStaMesa(View v){
             Intent i=null, chooser=null;
             if(v.getId()== R.id.StaMesaMap){
                 i = new Intent(Intent.ACTION_VIEW);
                 i.setData(Uri.parse("geo:14.600918, 121.010335"));
