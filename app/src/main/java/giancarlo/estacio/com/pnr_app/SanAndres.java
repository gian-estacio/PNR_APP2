...
public class SanAndres extends AppCompatActivity implements AdapterView.OnItemSelectedListener {

    EditText Distance, Fare, FareO;

    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.sanandres);
        ...
        // Spinner element
        Spinner spinner = (Spinner) findViewById(R.id.spinnerSanAndres);
    ...
    public void MapSanAndres(View v){
             Intent i=null, chooser=null;
              if(v.getId()== R.id.SanAndresMap){
                  i = new Intent(Intent.ACTION_VIEW);
                  i.setData(Uri.parse("geo:14.573120, 120.999545"));
